...
# Insert START record into DynamoDB
...
# Read VALIDATED XML, JSON, CSV

customers_df = spark.read.format("xml").option("rowTag", "Customer").load(xml_path)
...
purchases_df = purchases_df.withColumn("PurchaseDate", F.to_date("Date", "yyyy-MM-dd"))
...
# #  Amazon Bedrock Sentiment Enrichment
